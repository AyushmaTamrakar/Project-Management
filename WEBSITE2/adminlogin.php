...
<header class="headeropage">
  <nav>
    <a href="#0" aria-label="forecastr logo" class="logo">
      <img src="ClecKart Logo.png" width="140" height="140">
    ...
    <ul class="admin-menu">
      ...
      <li>
        <a href ="#0">
          ...
          <span><button onclick="on()">Customer</button></span>
        </a>
      </li>
      <li>
        <a href="#0">
          ...
          <span><button onclick="ont()">Trader</button></span>
        </a>
      </li>
      <li>
        <a href="#0">
          ...
          <span><button onclick="ono()">Order</button></span>
        </a>
      </li>
      <li>
        <a href="#0">
          ...
          <span><button onclick="onp()">Product</button></span>
        </a>
      </li>
      <li>
        <a href="#0">
          ...
          <span><button onclick="ons()">SHOP</button></span>
        </a>
      </li>
      <li>
        <a href="http://localhost:8080/apex/f?p=104:LOGIN_DESKTOP:7637218415905:::::">
          <svg>
            <use xlink:href="#collection"></use>
          </svg>
          <span><button>Reports</button></span>
        </a>
      </li>
      <li>
        <a href="logout.php">
...
<section class="page-content">
 ...
 <!--    <form>
  ...
  <section class="grid">
    <article id="customer"><h1>CUSTOMER</h1><?php 
    ...
    if(oci_execute($stid)){
       ...
       while($row=oci_fetch_assoc($stid)){
            ...
            echo "<tr>";
            echo "<td data-label=Product ID width=auto>".$row['CUSTOMERID']."</td>";
            echo "<td data-label=Name>".$row['NAME']."</td>";
            echo "<td data-label=Name>".$row['LASTNAME']."</td>";
            echo "<td data-label=Name>".$row['ADDRESS']."</td>";
            echo "<td data-label=Price>".$row['EMAIL']."</td>";
            echo "<td data-label=Stock>".$row['PASSWORD']."</td>";
            echo "<td data-label=Name>".$row['CONTACT']."</td>";
            echo "<td data-label=Name>".$row['GENDER']."</td>";
            echo "<td data-label=Name>".$row['DOB']."</td>";
     ...
     ?></article>
    <article id="trader"><h1>TRADER</h1><?php 
    ...
    if(oci_execute($stid)){
       ...
       while($row=oci_fetch_assoc($stid)){
            ...
            echo "<tr>";
            echo "<td data-label=Product ID width=auto>".$row['TRADERID']."</td>";
            echo "<td data-label=Name>".$row['TRADERNAME']."</td>";
            echo "<td data-label=Name>".$row['PANNUMBER']."</td>";
            echo "<td data-label=Price>".$row['EMAIL']."</td>";
           
            echo "<td data-label=Name>".$row['ADDRESS']."</td>";
            echo "<td data-label=Name>".$row['CONTACT']."</td>";
            echo "<td data-label=Name>".$row['STATUS']."</td>";
     ...
     ?></article><br><br><br>
    <article id="product"><h1>PRODUCTS</h1><?php 
    ...
    if(oci_execute($stid)){
       ...
       while($row=oci_fetch_assoc($stid)){
            ...
            echo "<td data-label=Name>".$row['NAME']."</td>";
            echo "<td data-label=Name>".$row['PROTYPE']."</td>";
            echo "<td data-label=Price>".$row['PRICE']."</td>";
           
            echo "<td data-label=Name>".$row['STOCK']."</td>";
            echo "<td data-label=Name>".$row['SHOPID']."</td>";
            echo "<td data-label=Name>".$row['STATUS']."</td>";
     ...
     ?></article><BR><BR><BR>
    <article id="order"><h1>ORDER</h1><?php 
    ...
    if(oci_execute($stid)){
       ...
       while($row=oci_fetch_assoc($stid)){
            ...
            echo "<tr>";
            echo "<td data-label=Product ID width=auto>".$row['ORDER_ID']."</td>";
            echo "<td data-label=Name>".$row['CUSTOMER_ID']."</td>";
            echo "<td data-label=Name>".$row['ORDER_TOTAL']."</td>";
            echo "<td data-label=Price>".$row['USER_NAME']."</td>";
           
            echo "<td data-label=Name>".$row['ORDERTIME']."</td>";
            echo "<td data-label=Name>".$row['ORDERDATE']."</td>";
            echo "<td data-label=Name>".$row['SLOTTIME']."</td>";
             echo "<td data-label=Name>".$row['SLOTDATE']."</td>";
     ...
     ?></article>
    <article id="shop"><h1>SHOP</h1><?php 
    ...
    if(oci_execute($stid)){
       ...
       while($row=oci_fetch_assoc($stid)){
            ...
            echo "<tr>";
            echo "<td data-label=Product ID width=auto>".$row['SHOPID']."</td>";
            echo "<td data-label=Name>".$row['SHOPREF']."</td>";
            echo "<td data-label=Name>".$row['SHOPNAME']."</td>";
            echo "<td data-label=Price>".$row['TRADERID']."</td>";         
            echo "</tr>";
