      ...
      <div class="logo">
        ...
        <div class="row">
          ...
          <div class="col-50">
            ...
            <label for="phone"><i class="fa fa-phone-card-o"></i> Phone Number</label>
            ...
            <div class="row">
              ...
              <div class="hour"><div class="time"><label for="time">Current Date:</label></div><div id="current_date" name="time">
              </div>
              </div><input type="hidden" name = "cdate" id="cdate">
               <div>
                 <div class="hour"><div class="time"><label for="time">Current Time:</label></div><div id="current_date2" name="time2"></div></label>
               </div><input type="hidden" name = "ctime" id="ctime">
...
document.getElementById("current_date").innerHTML=date_format.getDate()+'/'+ (date_format.getMonth()+1)+'/'+date_format.getFullYear();
document.getElementById("cdate").value = date_format.getDate()+'/'+ (date_format.getMonth()+1)+'/'+date_format.getFullYear();
...
document.getElementById("ctime").value = hr + ":" + min +":"+ sec;
