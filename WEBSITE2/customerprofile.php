...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $query = "UPDATE CUSTOMER SET NAME = '$name', CONTACT = '$pan', EMAIL='$mails', ADDRESS = '$add', PROFILEPIC = '$folder' WHERE CUSTOMERID ='".$_SESSION['ID']."'";
    $stid = oci_parse($conn, $query);
    if(oci_execute($stid)){
        echo"Image uploaded to datavbase!";
    }
    else{
    ...
    <div class="form">
        <div class="profile">
           <!--  <img src="" alt=" UPLOAD PROFILE IMAGE" class="avatar"> -->
            ...
            ?></h4><br/>
            <h2 class="button-set"><a href="changepassword_customer.php">Change Password</a></h2>
            ...
            <form method="POST" action=" " enctype="multipart/form-data">
                    <fieldset>
                       ...
                       <input type = "file" name="file"></input><br><br>
                        ...
                        <label for="pan no.">Contact:</label><br>
                        ...
                        <div class="box-button">
                            <button type="submit" method="post" name="profile" class="button" >Save</button>
                             <button type=""  class="button"><a href="http://localhost/Cleckart/WEBSITE/home.php">Start Shopping</a></button>
